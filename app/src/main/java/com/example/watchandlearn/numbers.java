...
//        getImage = (DatabaseReference) databaseReference.child("alphabets").child("0").child("logo_img");
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                i++;
                if(i <=9 ){
                    getId=(DatabaseReference)databaseReference.child("numbers").child(String.valueOf(i)).child("name");
                    getImage = (DatabaseReference) databaseReference.child("numbers").child(String.valueOf(i)).child("logo_img");
