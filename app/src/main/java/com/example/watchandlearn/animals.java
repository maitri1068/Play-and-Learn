        ...
        t1=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    t1.speak("Lion", TextToSpeech.QUEUE_FLUSH, null);
                    display_name=(TextView)findViewById(R.id.name);
                    display_name.setText("Lion");
                }
            }
        });
...
//        getImage = (DatabaseReference) databaseReference.child("alphabets").child("0").child("logo_img");
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getId=(DatabaseReference)databaseReference.child("animals").child(String.valueOf(i)).child("name");
                getImage = (DatabaseReference) databaseReference.child("animals").child(String.valueOf(i)).child("logo_img");
